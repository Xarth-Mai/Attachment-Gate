...
func TestVersionAndUsage(t *testing.T) {
	...
	if code := run(context.Background(), []string{"version"}, &stdout, &stderr); code != app.ExitOK || stdout.String() != "attachment-gate 0.1.3\n" {
...
func TestPolicyIdentity(t *testing.T) {
	...
	if got.ToolVersion != "0.1.3" || got.Profile.Name != "papersite-input-v1" || got.Profile.Version != 7 || len(got.EffectiveConfigSHA256) != 64 {
